...
namespace Febucci.UI.Core
{
    ...
    public abstract class TypewriterCore : MonoBehaviour
    {
        ...
        public void StartShowingText(bool restart = false, float delay = 0f)
        {
            ...
            isShowingText = true;
            showRoutine = StartCoroutine(ShowTextRoutine(delay));
        }
        ...
        IEnumerator ShowTextRoutine(float delay = 0f)
        {
	        if (delay > 0f)
	        {
